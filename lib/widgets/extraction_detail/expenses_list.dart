              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: imagesToShow.map((url) {
                    int pageIndex = imagesToShow.indexOf(url);
                    // This part needs a PageController listener to update active dot, or a more complex state management.
                    // For simplicity, this just draws dots without active state.
                    return Container(
                      width: 8.0,
                      height: 8.0,
